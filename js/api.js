...
(function () {
  ...
  var NET = {
    ...
    pointsBoard:    function () { return this.get("/leaderboard/points"); },
    polls:          function () { return this.get("/polls"); },
    pollCreate:     function (question, options) { return this.post("/polls", { question: question, options: options }); },
    pollVote:       function (id, optionId) { return this.post("/polls/" + id + "/vote", { optionId: optionId }); },
    pollClose:      function (id) { return this.post("/polls/" + id + "/close"); },
    room:           function () { return this.get("/room"); },
    roomMove:       function (x, y, emote) { return this.post("/room/move", { x: x, y: y, emote: emote }); },
    roomLeave:      function () { return this.post("/room/leave"); },
    ...
    adminUserPoints:  function (id, b) { return this.post("/admin/users/" + id + "/points", b); },
